...
#### 2.	Саунд дизайн
		...
		Max4Live:
			...
			Создания секвенций,
			Применение модулей для создания неординарных эффектов.
		...
		Обработка аудио, ресемплинг и использование слоев:
...
#### 3.	Работа с Аудио (PT12, LOGIC X, LIVE 9)
		...
		Flex Time & Flex Pitch(содержание этого раздела может быть изменено!):
			...
			Редактирование с помощью Flex time (Logic X), использование разных
			режимов,
			Ручное редактирование временных ошибок в аудио записи,
			Квантизация аудио записи,
			Редактирование с помощью Flex Pitch,
...
#### 4.	Создание аранжировки
		...
		Программирование ударных:
			...
			cymbals,
			Программирование ударных с использованием шагового секвестра в Maschine,
			Программирование ударных в Ableton Live Drum Rack,
...
#### 5.	Сведение (Mixing) (Pro Tools 12 и Logic X)
		...
		Разделение в миксе:
			...
			Принципы баланса уровней громкостей / сопоставление 
		...
		Все о компрессии и noise gate:
			...
			Применение компрессора к группе,
			Side-chain (pumping, deesser),
			Применение гейтов

		Реверберация:

			FX: использование железных устройств, коммутация ревербератора,
			Использование плагинов, auxes и шины/FX каналы,
		...
		Процесс сведения:
			...
			Гибридное сведение: использование микшера и DAW,
			Практическое прменение ранее изученого материала,
			Понимания всего процесса,
			Сведения трека за одну сессию


#### 6.	Мастеринг

		Что такое мастеринг и зачем он нужен?
		Использование референсных треков,
